...
class AllLocationMapperResponseToModelMapper : Mapper<LocationResponse, Location> {
    ...
    private fun List<ResultsLocationResponse>.mapToListResults(): List<ResultsLocation> = map {
        ResultsLocation(
            id =  it.id,
